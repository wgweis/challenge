...
{
    public static final String INSTANCE_NOT_NULL_MSG = "ResponseDatatransferObject instance cannot be null.  Plase initialize it first.";
    ...
    public void setElements(List<Integer[]> rangeElements) {this.rangeElements = rangeElements;}
